...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SBC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("da37f231-8920-5702-a09a-bdd970cb6ddc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SBC", artifacts_toml) for e in artifacts["SBC"]]
...
if best_platform === nothing
    @debug("Unable to load SBC; unsupported platform $(triplet(platform_key_abi()))")
else
